...
performance.
**Is there a source somewhere that affirms that this is not the priority of the R-Core team ?**
...
What we really need is time, and therefore financial support to sponsor that time. The estimated 
timeline aboves sums up to 720 hours of development time. This represents $72,000.
