...
As an example, to create a numeric vector of size `n` with all values set to `42.0`, we 
can use this syntax in `Rcpp`  

```
NumericVector x(n, 42) ;
```

It would be replaced by the more R-idiomatic 

```
NumericVector x = rep(42, n); 
```
