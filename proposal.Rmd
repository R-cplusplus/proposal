...
to allow our community to be taken hostage 
...
complicated binary incompatibility problems start to happen. Package developpers
...
transitionning from one implementation to the other will have to be based on documentation of
differences. Furthermore we cannot guarantee, at least in the project's infancy 
full compatibility between different versions. We aim to achieve flextability, i.e. a comprimse
